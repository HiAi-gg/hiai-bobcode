...
// Escape user-controlled strings before interpolating them into HTML so a
// malicious OAuth error_description / error parameter cannot inject script
// or break out of the error <div>.
