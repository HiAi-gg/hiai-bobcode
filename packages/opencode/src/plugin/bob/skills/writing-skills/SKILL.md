...
**Personal skills live in agent-specific directories (e.g., `~/.agents/skills/` or your agent's configured skills path)**
...
**Official guidance:** For skill authoring best practices, refer to your agent platform's documentation. This document provides patterns and guidelines that complement the TDD-focused approach in this skill.
...
- Project-specific conventions (put in your agent's rules file)
