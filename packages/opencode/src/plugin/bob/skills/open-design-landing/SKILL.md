...
description: Entry point for using the 150+ bundled brand design systems in design-systems/ to generate landing page HTML. Pairs with designer + Stitch MCP.
allowed-tools:
  - "Read"
  - "stitch*:*"
  - "Glob"
...
4. **Generate a landing page** using Stitch MCP (`generate_screen_from_text`) or hand-code HTML that faithfully applies the DESIGN.md tokens.
