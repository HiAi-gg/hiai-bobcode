...
export const dict = {
  ...
  "tui.tips.config_files":
    "创建 {highlight}hiai-bob.json{/highlight} 用于服务端配置，{highlight}tui.json{/highlight} 用于 TUI 配置",
  ...
  "tui.tips.mcp_oauth": "Bob 自动处理需要鉴权的远程 MCP 服务器的 OAuth",
  ...
  "tui.tips.formatter": "Bob 自动使用 prettier、gofmt、ruff 等格式化文件",
  ...
  "tui.tips.lsp": "Bob 使用 LSP 服务器进行智能代码分析",
  ...
  "tui.tips.plugin_protect": "写一个插件阻止 Bob 读取敏感文件",
  ...
  "tui.tips.serve": "运行 {highlight}mimo serve{/highlight} 以无头模式提供 Bob API",
  ...
  "tui.tips.zen": "搭配 Bob 使用 {highlight}/connect{/highlight} 选用经过测试的精选模型",
  ...
  "tui.voice.error.no_auth": "请先登录 Bob 账号",
  ...
  "tui.dialog.login.mimo_free.success": "Bob Auto (free) 已就绪 - 默认模型设为 mimo/mimo-auto",
  "tui.dialog.login.mimo_free.unavailable": "Bob Auto (free) 通道未加载",
  ...
  "cli.providers.mimo_free.verifying": "正在验证 Bob Auto (free) 通道...",
  "cli.providers.mimo_free.ready": "Bob Auto (free) 通道已就绪",
  "cli.providers.mimo_free.failed": "Bob Auto (free) 自检失败",
  "cli.providers.mimo_free.default_set": "默认模型已切换为 mimo/mimo-auto（1M 上下文，免费）",
  "cli.providers.mimo_free.usage_hint": "无需登录，直接 mimo run 即可使用。如需付费/更高级模型，可重新选择 Bob 浏览器登录。",
  ...
  "tui.dialog.login.flow.title": "Bob 登录",
