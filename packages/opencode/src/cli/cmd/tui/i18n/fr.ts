...
export const dict = {
  ...
  "tui.tips.config_files":
    "Créez {highlight}hiai-bob.json{/highlight} pour la configuration serveur et {highlight}tui.json{/highlight} pour le TUI",
  ...
  "tui.tips.lsp": "Bob utilise des serveurs LSP pour une analyse de code intelligente",
  ...
  "tui.voice.error.no_auth": "Veuillez d'abord vous connecter à Bob",
  ...
  "cli.providers.mimo_free.verifying": "Vérification du canal Bob Auto (free)...",
  "cli.providers.mimo_free.ready": "Canal Bob Auto (free) prêt",
  "cli.providers.mimo_free.failed": "Échec de la vérification de Bob Auto (free)",
