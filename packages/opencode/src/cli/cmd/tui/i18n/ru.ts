...
export const dict = {
  ...
  "tui.voice.error.no_auth": "Сначала войдите в аккаунт Bob",
  ...
  "cli.providers.mimo_free.verifying": "Проверка канала Bob Auto (free)...",
  "cli.providers.mimo_free.ready": "Канал Bob Auto (free) готов",
  "cli.providers.mimo_free.failed": "Не удалось проверить Bob Auto (free)",
  ...
  "cli.providers.mimo_free.usage_hint":
    "Вход не требуется — просто запустите mimo. Для платных/премиум-моделей выберите вход через браузер Bob.",
