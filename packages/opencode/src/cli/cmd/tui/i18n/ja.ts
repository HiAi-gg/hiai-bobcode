...
export const dict = {
  ...
  "tui.tips.mcp_oauth": "Bob は認証が必要なリモート MCP サーバの OAuth を自動処理します",
  ...
  "tui.tips.lsp": "Bob はインテリジェントなコード解析に LSP サーバを使います",
  ...
  "tui.tips.plugin_protect": "プラグインを書いて Bob が機密ファイルを読まないようにできます",
  ...
  "tui.tips.serve": "{highlight}mimo serve{/highlight} を実行するとヘッドレスで Bob API にアクセスできます",
  ...
  "tui.voice.error.no_auth": "まず Bob アカウントにログインしてください",
  ...
  "cli.providers.mimo_free.verifying": "Bob Auto (free) チャネルを検証中...",
  "cli.providers.mimo_free.ready": "Bob Auto (free) チャネル準備完了",
  "cli.providers.mimo_free.failed": "Bob Auto (free) の自己診断に失敗",
  "cli.providers.mimo_free.default_set": "デフォルトモデルを mimo/mimo-auto に設定（1M コンテキスト、無料）",
  "cli.providers.mimo_free.usage_hint":
    "ログイン不要 — そのまま mimo を実行できます。有料/上位モデルを利用する場合は Bob ブラウザログインを選択してください。",
