...
export const dict = {
  ...
  "tui.tips.mcp_oauth": "Bob 自動處理需要驗證的遠端 MCP 伺服器的 OAuth",
  ...
  "tui.tips.formatter": "Bob 自動使用 prettier、gofmt、ruff 等格式化檔案",
  ...
  "tui.tips.lsp": "Bob 使用 LSP 伺服器進行智慧程式碼分析",
  ...
  "tui.tips.serve": "執行 {highlight}mimo serve{/highlight} 以無介面模式提供 Bob API",
  ...
  "tui.tips.zen": "搭配 Bob 使用 {highlight}/connect{/highlight} 選用經過測試的精選模型",
  ...
  "tui.voice.error.no_auth": "請先登入 Bob 帳號",
