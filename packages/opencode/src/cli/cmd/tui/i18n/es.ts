...
export const dict = {
  ...
  "tui.tips.paste_image": "Pulsa {highlight}Ctrl+V{/highlight} para pegar imágenes desde el portapapeles en la entrada",
  "tui.tips.editor":
  ...
  "tui.tips.login": "Ejecuta {highlight}/login{/highlight} para iniciar sesión y usar tu plan de tokens",
  ...
  "tui.tips.mcp_oauth": "Bob gestiona automáticamente OAuth para servidores MCP remotos que requieran autenticación",
  ...
  "tui.tips.bash_allow": 'Usa patrones como {highlight}"git *": "allow"{/highlight} para permisos de bash más finos',
  ...
  "tui.tips.formatter": "Bob formatea archivos automáticamente con prettier, gofmt, ruff y más",
  ...
  "tui.tips.lsp": "Bob usa servidores LSP para análisis inteligente de código",
  ...
  "tui.tips.plugin_protect": "Crea un plugin que impida a Bob leer archivos sensibles",
  "tui.tips.run": "Usa {highlight}mimo run{/highlight} para scripting no interactivo",
  "tui.tips.continue": "Usa {highlight}mimo --continue{/highlight} para retomar la última sesión",
  "tui.tips.attach_cli": "Usa {highlight}mimo run -f file.ts{/highlight} para adjuntar archivos vía CLI",
  "tui.tips.format_json": "Usa {highlight}--format json{/highlight} para obtener salida legible por máquina en scripts",
  "tui.tips.serve": "Ejecuta {highlight}mimo serve{/highlight} para acceso headless a la API de Bob",
  "tui.tips.attach_server": "Usa {highlight}mimo run --attach{/highlight} para conectarte a un servidor en ejecución",
  "tui.tips.upgrade": "Ejecuta {highlight}mimo upgrade{/highlight} para actualizar a la última versión",
  "tui.tips.auth_list": "Ejecuta {highlight}mimo auth list{/highlight} para ver todos los proveedores configurados",
  "tui.tips.agent_create": "Ejecuta {highlight}mimo agent create{/highlight} para crear un agente con asistente guiado",
  "tui.tips.github_trigger": "Usa {highlight}/opencode{/highlight} en issues/PR de GitHub para disparar acciones de IA",
  "tui.tips.github_install": "Ejecuta {highlight}mimo github install{/highlight} para configurar el workflow de GitHub",
  ...
  "tui.tips.theme_files": "Crea archivos JSON de tema en el directorio {highlight}.mimocode/themes/{/highlight}",
  ...
  "tui.tips.zen": "Usa {highlight}/connect{/highlight} con Bob para modelos seleccionados y probados",
  ...
  "tui.voice.error.no_auth": "Inicia sesión en Bob primero",
  ...
  "tui.dialog.login.mimo_free.desc": "Canal anónimo gratuito — sin inicio de sesión",
  "tui.dialog.login.mimo_free.success": "Bob Auto (free) listo — modelo por defecto establecido en mimo/mimo-auto",
  "tui.dialog.login.mimo_free.unavailable": "Proveedor Bob Auto (free) no cargado",
  "tui.dialog.login.import_claude": "Importar desde Claude Code",
  "tui.dialog.login.other": "Otro proveedor",
  "tui.dialog.login.import_claude.no_key": "No se encontró la clave de API de Claude Code",
  ...
  "tui.dialog.login.start_failed": "No se pudo iniciar el inicio de sesión",
  "tui.dialog.login.flow.title": "Inicio de sesión en Bob",
  "tui.dialog.login.flow.placeholder": "Pega el código (o espera la respuesta del navegador)",
  "tui.dialog.login.flow.busy": "Iniciando sesión...",
  "tui.dialog.login.flow.manual_hint": "¿No se abrió el navegador? Visita manualmente:",
  "tui.dialog.login.flow.waiting": "Esperando la autorización del navegador...",
  "tui.dialog.login.flow.invalid_code": "Código no válido, inténtalo de nuevo",
