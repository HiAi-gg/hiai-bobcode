...
export const dict = {
  ...
  "tui.tips.mcp_oauth":
    "Bob gestiona automáticamente OAuth para servidores MCP remotos que requieran autenticación",
  ...
  "tui.tips.plugin_protect":
    "Crea un plugin que impida a Bob leer archivos sensibles",
  "tui.tips.run":
  ...
  "tui.tips.serve":
    "Ejecuta {highlight}mimo serve{/highlight} para acceso headless a la API de Bob",
  ...
  "tui.tips.zen":
    "Usa {highlight}/connect{/highlight} con Bob para modelos seleccionados y probados",
  "tui.tips.agents_md":
