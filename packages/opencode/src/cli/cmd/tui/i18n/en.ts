export const dict: Record<string, string> = {
  ...
  "tui.tips.config_files":
    "Create {highlight}hiai-bob.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  ...
  "tui.tips.mcp_oauth": "Bob auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "tui.tips.formatter": "Bob auto-formats files using prettier, gofmt, ruff, and more",
  ...
  "tui.tips.lsp": "Bob uses LSP servers for intelligent code analysis",
  ...
  "tui.tips.plugin_protect": "Create a plugin to prevent Bob from reading sensitive files",
  ...
  "tui.tips.serve": "Run {highlight}mimo serve{/highlight} for headless API access to Bob",
  ...
  "tui.tips.zen": "Use {highlight}/connect{/highlight} with Bob for curated, tested models",
  ...
  "tui.voice.error.no_auth": "Please log in to Bob first",
  ...
  "tui.dialog.login.mimo_free.success": "Bob Auto (free) is ready — default model set to mimo/mimo-auto",
  "tui.dialog.login.mimo_free.unavailable": "Bob Auto (free) provider not loaded",
  ...
  "cli.providers.mimo_free.verifying": "Verifying Bob Auto (free) channel...",
  "cli.providers.mimo_free.ready": "Bob Auto (free) channel ready",
  "cli.providers.mimo_free.failed": "Bob Auto (free) verification failed",
  "cli.providers.mimo_free.default_set": "Default model set to mimo/mimo-auto (1M context, free)",
  "cli.providers.mimo_free.usage_hint": "No login required — just run mimo. For paid/premium models, choose Bob browser login instead.",
  ...
  "tui.dialog.login.flow.title": "Bob Login",
