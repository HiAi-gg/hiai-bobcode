...
- Generate platform icons using your preferred icon tool (e.g., `electron-icon-builder` or manual scaling)
...
The Image2Icon step is necessary as the `icon.icns` generated from `app-icon.png` does not apply the shadow/padding expected by macOS,
